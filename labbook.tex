...
\addtokomafont{caption}{\footnotesize} % Small font size for captions
\addtokomafont{captionlabel}{\upshape\bfseries} % Bold for caption labels
\addtokomafont{descriptionlabel}{\rmfamily}
\setcapwidth[r]{.8\textwidth} % Right align caption text
...
% -------------------------------
\part{LAB NOTES}
\include{chap/lab-notes}
% -------------------------------
\part{ANNOTATIONS}
\include{chap/books}
\include{chap/articles}
